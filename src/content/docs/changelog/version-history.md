---
title: 버전 히스토리
description: SRR 방법론의 변경 이력과 주요 업데이트 내용을 버전별로 정리합니다.
---

이 문서는  
SRR(Structured & Reusable Rules) 방법론의  
...
SRR 방법론의 첫 번째 공식 버전입니다.  
SLUR 내부 실무 경험을 바탕으로  
UI 구조와 네이밍 규칙을 체계화한 기준을 정리했습니다.

#### 주요 내용

- SRR Methodology 기본 개념 정의
- UI 구조 단위 구분
  - 레이아웃(layout_)
  - 페이지(page_)
  - 컴포넌트(접두사 없음)
...
**SRR이 어떤 맥락에서 발전해왔는지 이해하기 위한 기록**입니다.
