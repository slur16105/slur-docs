...
(function (global) {
  ...
  /* ── 토스트 ───────────────────────────────────
     ...
     알림은 포커스를 옮기지 않는다. 한 번에 하나, 나머지는 큐. — APG Alert · WCAG 4.1.3 */
  const toast = {
    queue: [], current: null, timer: null, fade: 250,
  ...
  const slur = { tabs, menu, tooltip, toast: toast.show, drawer, theme, version: '1.7.0' };
